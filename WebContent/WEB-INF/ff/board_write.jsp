	...
	<div class="row mt">
		<div class="col-lg-12">
			<div class="form-panel">
				...
				<form class="form-horizontal style-form" action="/kimsaemERP/board/insert.do" method="post">
					<div class="form-group" style="border: 1px solid #eff2f7;">
						<label class="col-sm-2 col-sm-2 control-label">작성자</label>
						<div class="col-sm-10">

							<p class="form-control-static"><input type="text" name="bo_id"></p>
						</div>
						<div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label">게시글 유형</label>

							<div class="col-sm-5">
								<select name="bo_div" class="form-control">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea id="content"
									...
									rows=15 name="bo_txt">글작성</textarea>
